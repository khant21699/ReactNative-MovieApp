...
export const genreEndpoint = `${apiBaseUrl}/genre/movie/list?api_key=${apiKey}&language=en`;
// movie screen apis
...
export const fetchMovieWithGenre = (param) => {
  const searchwithGenreEndpoint = `${apiBaseUrl}/discover/movie?api_key=${apiKey}&language=en-US&with_genres=${param}
  `;
  return apiCall(searchwithGenreEndpoint);
};
